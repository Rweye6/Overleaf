...
\section{Force életcrique}
\begin{frame}
    \frametitle{Champ et force électrostatique}
    Toute particule chargée,  du fait de sa charge $q$, engendre autour d'elle un champ électrostatique noté $E$ et exeprimé en \unit{\volt\per\meter}.\\
    \includegraphics[width = .2\textwidth]{Ressources/1SPE_C11_ChElec_dipole.png} \hspace{3em} \includegraphics[width = .2\textwidth]{Ressources/1SPE_C11_ChElec_champ.png}\\
    
    À noter : \\
    Les lignes de champ parte,t des charges positives et vont vers les charges négatives dan stoutes les directions de l'espace.\\
    Une particule de charge $q'$ placée ç une distance $d$ de la charge $q$ subira une force attractive ou répulsive d'intensité :
