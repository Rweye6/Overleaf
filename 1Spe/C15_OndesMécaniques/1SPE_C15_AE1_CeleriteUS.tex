...
\begin{enumerate}
    ...
    L'écart relatif $e$ est donné par la relation : $e =\dfrac{|c_{exp} - c_{ref}|}{c_{ref}}$ où $c_{ref}$ est la célérité déterminée par l'expérience tandis que $c_{ref}$ est la valeur de référence.
\end{enumerate}
