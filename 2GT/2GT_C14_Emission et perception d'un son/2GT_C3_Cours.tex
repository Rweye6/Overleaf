...
Le timbre d’un son est quant à lui lié à la forme du signal sonore.
	...
	\begin{minipage}{.48\linewidth}
		...
		Le niveau d’intensité sonore se mesure à l’aide d’un sonomètre $\rightarrow$
	\end{minipage}
	\begin{minipage}{.5\linewidth}
		...
		\begin{tikzpicture}
			...
			\node[left, color= red!60!black] at (0,9) {\textbf{Intensité sonore $\mathbf{I}$ (\unit{\watt\per\meter\squared})}};
			\node[right, color= green!60!black] at (0,9) {\textbf{Niveau d'intensité sonore $\mathbf{L}$ (\unit{\deci\bel})}};
		\end{tikzpicture}
		\vspace{2em}

		\includegraphics[width=0.9\linewidth]{Ressources/2GT_C7_Fig2.png}
	\end{minipage}
