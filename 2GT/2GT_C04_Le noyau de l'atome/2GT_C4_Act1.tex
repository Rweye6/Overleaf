...
\noindent \begin{minipage}{\linewidth}
	\textbf{Document 1 : La structure de l'atome}\\
...
\noindent\begin{minipage}[t]{.55\linewidth}
	\textbf{Document 2 : La notation symbolique}\\
...
Deux noyaux peuvent avoir lcolse même nombre de protons mais un nombre de neutrons différents, ils sont appelés des \textbf{isotopes.}\\
...
\begin{minipage}[t]{.4\linewidth}
	\textbf{Document 3 : Données supplémentaires }\\
