...
\section{Exemples de forces}
    {\usebackgroundtemplate{
        \includegraphics[width=\paperwidth,height=\paperheight]{Ressources/bluetechBG.jpg}}
    \begin{frame}{Exemples de forces}
    
    \begin{minipage}{.6\linewidth}
        \includegraphics[width=\linewidth]{Ressources/2GT_C12_Cours_Forces.png}
    \end{minipage}
    
    \hspace{3cm}\begin{minipage}{.6\linewidth}
        \includegraphics[width=\linewidth]{Ressources/2GT_C12_Cours_Forces2.png}
    \end{minipage}
    \end{frame}
    }
...
\section{Le principe d'inertie}
    ...
    {\usebackgroundtemplate{
        \includegraphics[width=\paperwidth,height=\paperheight]{Ressources/inertieBG.jpg}}
        \begin{frame}{Le principe d'inertie}
        \end{frame}
    }
