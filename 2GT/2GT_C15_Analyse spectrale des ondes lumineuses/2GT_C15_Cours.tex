...
\begin{figure}[h!]
    \caption*{\textbf{Document 1 : Plein les yeux}}
...
\begin{figure}[h!]
    \caption*{\textbf{Document 2 : Orion le chasseur}}
...
\begin{figure}[h!]
    ...
    \includegraphics[width=.5\linewidth]{Ressources/Act1_fig2.png}
    \label{fig:doc3}
\end{figure}
...
\begin{minipage}{.48\linewidth}
	\centering \includegraphics[width=.5\linewidth]{Ressources/qR_PHET_Corps_chaud.png}
\end{minipage}	
