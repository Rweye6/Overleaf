...
\begin{document}
\title{\textbf{Chapitre 11 : Décrire un mouvement}}
\author{}
\date{}

\setbeamercolor{background canvas}{bg=violet!5!white}
...
\begin{frame}
	...
	\frametitle{Description d'un système en physique}
		...
		\begin{tikzpicture}
		\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\textwidth]{Ressources/Diapo_Fig1.png}};
		%\draw (0,0) grid(5,4);
...
\begin{frame}
	...
	\begin{minipage}{.48\linewidth}
		...
		\onslide<1-> \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=3cm]{Ressources/Diapo_Fig2.png}};
		%\draw (0,0) grid(3,6);
		%\node[below] (m) at (2.5,1.5) {$M$};
		\onslide<2-> \node (M) at (.6,.6) {+};
		\onslide<2-> \node (M) at (.76,1.6) {+};
...
\begin{frame}
	...
	\begin{center}
		\begin{tikzpicture}
		\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width = \linewidth]{Ressources/maps2.png}};
		\end{tikzpicture}
	\end{center}
\end{frame}
...
font=\small}]
		...
		\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width = 10cm]{Ressources/maps2.png}};
...
\begin{frame}
	%\frametitle{Vecteur vitesse}
	\begin{minipage}{.5\textwidth}
		Il faut disposer d'au moins trois positions du système. On aura le \textbf{vecteur vitesse moyenne} d'un système au point $M_2$, situé entre les dates $t_1$ et $t_3$ qui aura pour expression : $$\vv{v_2} = \dfrac{\vv{M_2M_3}}{t_3-t_1}$$
...
\begin{frame}
	...
	\frametitle{Variation du vecteur vitesse}
	\begin{minipage}{\linewidth}
		\centering
		\includegraphics[width = \linewidth]{Ressources/kinetic_blur.jpg}
	\end{minipage}
\end{frame}
...
\begin{frame}
	...
	\frametitle{Variation du vecteur vitesse}
	\begin{minipage}{.5\textwidth}
		\textbf{Variation de la norme du vecteur vitesse :}\\
		\begin{itemize}
...
\begin{frame}
	...
	\begin{minipage}{.4\textwidth}
		\textbf{Variation de la direction et du sens :}\\
		\begin{itemize}
...
\begin{frame}
	\textbf{Description d'un mouvement :}
	\begin{small}
