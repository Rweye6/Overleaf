...
DOSSIERS = os.listdir("/home/rweye/Nextcloud/Documents/Overleaf/TSPE/")
fichiers = []
dossier = ""
mot=".tex"
for j in range(len(DOSSIERS)):
     os.chdir("/home/rweye/Nextcloud/Documents/Overleaf/TSPE/"+DOSSIERS[j])
     dossier = os.listdir("/home/rweye/Nextcloud/Documents/Overleaf/TSPE/"+DOSSIERS[j])
