...
Un \textbf{courant électrique} correspond à un déplacement de porteurs de charge électrique. Dans les matériaux métalliques, ces porteurs de charge sont les électrons.\\
...
\begin{minipage}{.4\linewidth}
	\centering \begin{tikzpicture}[scale=.75,transform shape]
...
\end{eqnarray}\\
	\hline \textbf{4. Allure de la courbe} & \includegraphics[scale=.4]{Ressources/TSPE_C11_Cours_Fig1.png}&\includegraphics[scale=.4]{Ressources/TSPE_C11_Cours_Fig2.png}\\
	\hline
	\end{tabular}
%\end{landscape}
...
\noindent
	\begin{minipage}{.6\linewidth}
		$\tau$ permet de déterminer la durée de la charge ou de la décharge d'un dipôle RC. Plus $\tau$ est grand, plus la durée de charge ou de décharge est grande. Au bout de $5\tau$, on considère que le condensateur est chargé ou déchargé (la tension $u_C$ a atteint sa valeur finale à 0,67 \% près). Le \textbf{régime transitoire} est alors considéré comme terminé et un \textbf{régime permanent stationnaire} s'établit.
	\end{minipage}
\begin{minipage}{.4\linewidth}
