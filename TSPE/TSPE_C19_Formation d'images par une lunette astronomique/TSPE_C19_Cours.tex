...
\title{\vspace{-1cm}\large 
	\begin{tabular}{|>{\centering}m{5cm}|>{\centering}m{8cm}|>{\centering\arraybackslash}m{4cm}|}
		\hline
		Cours & \textbf{\textsc{Lunette astronomique}} &  Chapitre 11 \\
		\hline
\end{tabular}}
\date{}
...
\begin{document}
	...
	\begin{minipage}{.4\linewidth}
		\centering \includegraphics[width=\linewidth]{Ressources/TSPE_C13_Cours_Fig1.png}
	\end{minipage}
	...
	\end{minipage}}
		...
		\end{minipage}
	\begin{minipage}{.4\linewidth}
		\centering \includegraphics[width=\linewidth]{Ressources/TSPE_C13_Cours_Fig2.png}
	\end{minipage}
\end{document}