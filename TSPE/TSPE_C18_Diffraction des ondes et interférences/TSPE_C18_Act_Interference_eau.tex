...
%\begin{figure}[h!]
  \noindent\begin{minipage}[t]{.48\linewidth}
    \begin{documentboxenv}{Ondes à la surface de l'eau}
    \label{doc1}
  ...
  \begin{minipage}[t]{.5\linewidth}
    \begin{documentboxenv}{interférences entre deux ondes cohérentes}
    \label{doc2}
...
\newpage
  ...
  \begin{documentboxenv}{Schémma de la situation}
  \label{doc3}
  \large
