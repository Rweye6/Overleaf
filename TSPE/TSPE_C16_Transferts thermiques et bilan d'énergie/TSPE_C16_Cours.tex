...
\end{center}
	...
	\begin{center}
		\begin{tabular}{|c|c|c|}
			...
			\hline
			\textbf{Illustration}&\includegraphics[scale = .2]{Ressources/TSPE_C14_Cours_Fig3b.png}&\includegraphics[scale = .2]{Ressources/TSPE_C14_Cours_Fig4b.png}\\
			\hline
	\end{tabular}
	\end{center}}
	...
	\begin{tabular}{|>{\centering}m{5cm}|>{\centering}m{5cm}|>{\centering\arraybackslash}m{8cm}|}
		\hline
		\textbf{Conduction thermique}&\includegraphics[scale = .35]{Ressources/TSPE_C14_Cours_Fig5.png}&Transfert de proche en proche, par des mouvements microscopiques des entités, mais sans déplacement macroscopique de matière. $\rightarrow$ \emph{dans les solides}\\
		\hline
		\textbf{Convection thermique}&\includegraphics[scale = .25]{Ressources/TSPE_C14_Cours_Fig6.png}& Transfert généré par un mouvement d'ensemble d'un fluide. $\rightarrow$ \emph{dans les fluides (gaz ou liquides)}\\
		\hline
		\textbf{Rayonnement thermique}&\includegraphics[scale = .35]{Ressources/TSPE_C14_Cours_Fig7.png}&transfert par absorption ou émission d'ondes électromagnétiques. $\rightarrow$ \emph{dans tous les milieux, y compris dans le vide}\\
		\hline
	\end{tabular}
...
\newpage
	...
	%\pagebreak
		...
		\hline
		\multicolumn{2}{|c|}{\includegraphics[scale=.8]{Ressources/TSPE_C14_Cours_Fig8.png}}\\
		\hline
	\end{xtabular}
\newpage
