...
\begin{figure}[h!]
    ...
    \includegraphics[scale=.6]{Ressources/TSPE_C3_AE_Fig1.png}
    \end{minipage}
     & 
...
\begin{enumerate}[resume]
	...
	\end{itemize} & \includegraphics[scale=.2]{Ressources/TSPE_C3_AE_Fig2.png}\\
	\end{tabular}
...
\end{enumerate}
	...
	\begin{itemize}
		\item Appliquer la méthode des tangentes à la courbe précédemment obtenue (clic droit, puis parcourir la courbe) et relever le volume $V_{B,E}$ de solution titrante versé à l'équivalence.
	\end{itemize}
...
\textbf{Données :}
\begin{itemize}
	\item Masse molaire de l'acide éthanoïque : $M(\ce{CH3COOH})$ = \SI{60,0}{\gram\per\mole}
	\item Densité du vinaigre commercial à \SI{20}{\celsius} : $d$ = \num{1,02}
\end{itemize}
\end{minipage}
}
\end{document}