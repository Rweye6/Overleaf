\documentclass[a4paper,10pt,fleqn]{article}%fleqn pour aligner les equations à gauche
...
\begin{documentboxenv}{Abaissement du ton au passage d'un train}
\begin{center}
...
\begin{minipage}{\linewidth}
    \begin{documentboxenv}{Expérience de Buys-Ballot}
    \begin{center}
        \includegraphics[width=.8\linewidth]{Ressources/TSPE_C17_Act_Fig1.png}
    \end{center}
...
\begin{documentboxenv}{Source sonore en mouvement}
\begin{center}
    \includegraphics[width=.8\linewidth]{Ressources/TSPE_C17_Act_Fig2.png}
\end{center}
\end{documentboxenv}
%\end{minipage}

%\noindent\fbox{\begin{minipage}{\linewidth}
\begin{documentboxenv}{Fréquences de quelques notes de musiques}
\begin{center}
...
\begin{enumerate}
    ...
    \item Calculer la vitesse à laquelle ce train se déplaçait.
