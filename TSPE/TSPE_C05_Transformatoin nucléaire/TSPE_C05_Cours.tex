...
\begin{document}
	...
	\begin{itemize}
		...
		\includegraphics[scale=.5]{Ressources/TSPE_C15_Cours_Fig2.png}}\\
		...
		\includegraphics[scale=.5]{Ressources/TSPE_C15_Cours_Fig3.png}}\\
...
\section{Décroissance radioactive}
	...
	Pour une durée infiniment faible :
		...
		\begin{tabular}{|>{\centering}m{6cm}|>{\centering}m{6cm}|>{\centering\arraybackslash}m{6cm}|}
			...
			\hline
			\includegraphics[scale=.5]{Ressources/TSPE_C15_Cours_Fig4a.png}&\includegraphics[scale=.5]{Ressources/TSPE_C15_Cours_Fig4b.png}&\includegraphics[scale=.5]{Ressources/TSPE_C15_Cours_Fig4c.png} \rule[3cm]{0cm}{0cm}\\
